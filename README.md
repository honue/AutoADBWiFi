...
KSKernelSU 模块，用于管理 **Wi‑Fi 热点**以及 **ADB USB / Wi‑Fi 调试模式**。
...
1. https://github.com/honue/AutoADBWiFi/releases/latest/download/AutoADBWiFi.zip
2. 安装完成后重启设备
3. 在模块列表中打开 AutoADBWiFi 配置页面
